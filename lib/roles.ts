...
export const ROLE_ROUTE_RULES: Array<{
  ...
  { prefix: "/dashboard/payments", roles: ["admin"] },
  { prefix: "/dashboard/scholarships", roles: ["admin"] },
  ...
  { prefix: "/dashboard/messages", roles: ["student", "tutor"] },
  { prefix: "/dashboard/leaderboard", roles: ["student"] },
  { prefix: "/dashboard/certificates", roles: ["student"] },
